...
if ($output==null) {
	$error = new OEReturn("errorCounter",utf8_encode(GetErrMessage(null,$WEInfoPage,"CounterError"))); //"Impossible de récupéré les données des compteurs."
